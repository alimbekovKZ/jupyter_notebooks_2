...
print("lgb model")
bagging_fraction=0.8554035310857978
feature_fraction=0.5799210205193864
max_depth=49
min_child_weight=0.00571755417216398
min_data_in_leaf=22
num_leaves=274
reg_alpha=1.2377296798852808
reg_lambda=1.5488410439395452
...
subname = '../output/ieee_lgb_para_opt.csv'
