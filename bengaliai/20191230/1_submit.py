...
def run_submit():
    ...
    # out_dir = '/root/share/project/kaggle/2020/grapheme_classification/result/run1/dense121-fold0'
    # initial_checkpoint = \
    #     out_dir + '/checkpoint/swa_fold0_no_bn_model.pth'
    #     #out_dir + '/checkpoint/00067000_model.pth'

    valid_split = 'balance2/valid_b_fold1_15985.npy'
    out_dir = 'dense121-fold0'
    initial_checkpoint = 'checkpoint_final/00198000_model.pth' #swa_fold1_no_bn_model.pth'
...
'''
# without swa
initial_checkpoint  = /root/share/project/kaggle/2020/grapheme_classification/result/run1/dense121-fold0/checkpoint/00067000_model.pth
submitting .... @ ['null'] 
avgerage_recall : 0.972391
               grapheme_root  0.960371
             vowel_diacritic  0.987422
         consonant_diacritic  0.981400



# with swa
initial_checkpoint  = /root/share/project/kaggle/2020/grapheme_classification/result/run1/dense121-fold0/checkpoint/swa_fold0_no_bn_model.pth
submitting .... @ ['null']
avgerage_recall : 0.973375
               grapheme_root  0.961821
             vowel_diacritic  0.988229
         consonant_diacritic  0.981631
